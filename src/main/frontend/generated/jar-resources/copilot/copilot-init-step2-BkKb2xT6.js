import { u as y, v as I, w as V, b as g, j as r, C as q, x as c, y as Re, z as S, A as Z, B as L, O as ce, D as A, F as l, G as De, H as Je, I as Ve, J as Q, K as me, E as u, L as Fe, k as pe, l as qe, P as Xe, N as Ye, V as We, Q as Ee, R as $, S as Ge, T as M, M as _, U as h, W as Ke, X, Y as Ze, Z as ve, _ as ze, $ as Qe, a0 as et, a1 as tt, a2 as it, a3 as nt, a4 as ot, a5 as st, a6 as Le, a7 as at, a8 as rt, a9 as lt, aa as dt, ab as Me, ac as ct, ad as he, ae as pt, af as ht } from "./copilot-BVlb74ld.js";
import { n as D, r as C } from "./state-TTSaAh7U.js";
import { e as O, m as ue } from "./overlay-monkeypatch-Cv4NXUk7.js";
import { i as d } from "./icons-UABUWkBQ.js";
import { e as E } from "./early-project-state-CqEloDes.js";
const ut = 1, be = 36, gt = 18;
function ft(e, t) {
  if (e.length === 0)
    return;
  const i = mt(e, t);
...
function mt(e, t) {
  ...
  return e.map((s) => {
    const a = s.panelInfo;
    return a && !a.expanded ? be : (t.offsetHeight - (t.position === "bottom" ? gt : 0) - o * be - i * ut) / n;
  });
}
var vt = Object.defineProperty, bt = Object.getOwnPropertyDescriptor, T = (e, t, i, n) => {
  for (var o = n > 1 ? void 0 : n ? bt(t, i) : t, s = e.length - 1, a; s >= 0; s--)
    (a = e[s]) && (o = (n ? a(t, i, o) : a(o)) || o);
  return n && o && vt(t, i, o), o;
};
const ee = "data-drag-initial-index", B = "data-drag-final-index";
let k = class extends I {
  constructor() {
    super(...arguments), this.position = "right", this.opened = !1, this.keepOpen = !1, this.resizing = !1, this.closingForcefully = !1, this.draggingSectionPanel = null, this.panelCountChanged = V(() => {
      this.refreshSplit();
      ...
      e.stopPropagation(), e.preventDefault(), requestAnimationFrame(() => {
        ...
        if (this.position === "right") {
          ...
          this.style.setProperty("--size", `${o}px`), q.saveDrawerSize(this.position, o), n = { width: o };
        } else if (this.position === "left") {
          const o = t;
          this.style.setProperty("--size", `${o}px`), q.saveDrawerSize(this.position, o), n = { width: o };
        } else if (this.position === "bottom") {
          const o = document.body.clientHeight - i;
          this.style.setProperty("--size", `${o}px`), q.saveDrawerSize(this.position, o), n = { height: o };
        }
        this.setActualSize(), c.panels.filter((o) => !o.floating && o.panel === this.position).forEach((o) => {
      ...
      this.getAllPanels().sort((t, i) => {
        ...
        if (t.setAttribute(B, `${i}`), t.panelTag !== this.draggingSectionPanel?.panelTag) {
          const n = Number.parseInt(t.getAttribute(ee), 10);
  ...
  connectedCallback() {
    ...
    const e = q.getDrawerSize(this.position);
    e && (this.style.setProperty("--size", `${e}px`), this.setActualSize()), document.addEventListener("mousemove", this.resizingMouseMoveListener), this.addEventListener("mouseenter", this.mouseEnterListener), g.on("document-activation-change", (t) => {
      this.toggleAttribute("document-hidden", !t.detail.active);
    }), g.on("panel-expanded", this.panelExpandedListener), g.on("copilot-main-resized", this.setActualSize), this.reaction(
      () => c.panels.filter(
  ...
  cleanUpDragging() {
    this.draggingSectionPanel && (r.setSectionPanelDragging(!1), this.draggingSectionPanel.style.zIndex = "", Array.from(this.querySelectorAll("copilot-section-panel-wrapper")).forEach((e) => {
      e.style.removeProperty("transform"), e.removeAttribute(B), e.removeAttribute(ee);
  ...
  refreshSplit() {
    ft(this.getAllPanelsOrdered(), this);
  }
};
T([
...
var wt = Object.defineProperty, yt = Object.getOwnPropertyDescriptor, _e = (e, t, i, n) => {
...
const P = new xt();
var Pt = Object.defineProperty, At = Object.getOwnPropertyDescriptor, H = (e, t, i, n) => {
...
let w = class extends I {
  constructor() {
    super(), this.javaPluginSectionOpened = !1, this.hotswapSectionOpened = !1, this.hotswapTab = "hotswapagent", this.downloadStatusMessages = [], this.downloadProgress = 0, this.onDownloadStatusUpdate = this.downloadStatusUpdate.bind(this), this.reaction(
      ...
      () => {
        r.idePluginState && (!r.idePluginState.ide || !r.idePluginState.active ? this.javaPluginSectionOpened = !0 : (!(/* @__PURE__ */ new Set(["vscode", "intellij"])).has(r.idePluginState.ide) || !r.idePluginState.active) && (this.javaPluginSectionOpened = !1)), r.jdkInfo && Q() !== "success" && (this.hotswapSectionOpened = !0);
      },
      { fireImmediately: !0 }
    );
  }
  ...
  render() {
    ...
    return l`
      ...
      <div part="footer">
        <vaadin-button
          id="close"
          @click="${() => c.updatePanel(ge.tag, { floating: !1 })}"
          >Close
        </vaadin-button>
      </div>
    `;
  ...
  renderPluginIsNotInstalledContent(e) {
    ...
    return e.intellij ? (t = Ye, i = "Install from JetBrains Marketplace") : e.vscode && (t = We, i = "Install from VSCode Marketplace"), l`
      <div>
      ...
      <div class="inner-section">
        <details class="inner" .open="${!t}">
          ...
          <div class="hint">
            ...
            <ul>
              ${e.intellij && It("1.3.0", r.idePluginState?.version) ? l` <li>Upgrade to the latest IntelliJ plugin</li>` : u}
  ...
  async downloadJetbrainsRuntime(e) {
    return e.target.disabled = !0, e.preventDefault(), this.downloadStatusMessages = [], pe(`${Xe}set-up-vs-code-hotswap`, {}, (t) => {
      t.data.error ? (qe("Error downloading JetBrains runtime", t.data.error), this.downloadStatusMessages = [...this.downloadStatusMessages, "Download failed"]) : this.downloadStatusMessages = [...this.downloadStatusMessages, ye];
    });
  }
...
window.Vaadin.copilot.plugins.push(Ct);
c.addPanel(ge);
...
var kt = Object.getOwnPropertyDescriptor, Rt = (e, t, i, n) => {
...
function Oe(e, t) {
  ...
  if (t.label) {
    ...
    const n = Ge(t.component) ? t.component : document.createElement(t.component);
    i.append(n);
  }
  if (t.hint) {
    const n = document.createElement("span");
...
function Te(e) {
  return pe("copilot-switch-user", { username: e }, (t) => t.data.error ? (M({ type: _.ERROR, message: "Unable to switch user", details: t.data.error.message }), !1) : !0);
}
var Dt = Object.defineProperty, Et = Object.getOwnPropertyDescriptor, U = (e, t, i, n) => {
  for (var o = n > 1 ? void 0 : n ? Et(t, i) : t, s = e.length - 1, a; s >= 0; s--)
    (a = e[s]) && (o = (n ? a(t, i, o) : a(o)) || o);
  return n && o && Dt(t, i, o), o;
};
const zt = 8;
function Lt() {
...
let F = class extends I {
  constructor() {
    super(...arguments), this.initialMouseDownPosition = null, this.dragging = !1, this.items = [], this.mouseDownListener = (e) => {
      ...
      if (this.initialMouseDownPosition && !this.dragging) {
        const { clientX: t, clientY: i } = e;
        this.dragging = Math.abs(t - this.initialMouseDownPosition.x) + Math.abs(i - this.initialMouseDownPosition.y) > zt;
      }
      ...
      return i ? Array.from(i).some((o) => {
        ...
        return Re(new DOMRect(m, v, x, N), e.clientX, e.clientY);
      }) : !1;
        ...
        children: [
            ...
            children: [
              {
                ...
                keepOpen: !0,
                action: (o) => {
                  h.setActivationShortcut(!h.isActivationShortcut()), ie(o, h.isActivationShortcut());
                }
              },
              {
                component: f({
                ...
                keepOpen: !0,
                action: (o) => {
                  h.setActivationAnimation(!h.isActivationAnimation()), ie(o, h.isActivationAnimation());
                }
              },
              {
                component: f({
                ...
                action: (o) => {
                  ...
                  a === "ask" ? s = "yes" : a === "no" ? s = "ask" : s = "no", h.setAIUsageAllowed(s), Ot(o);
                }
              },
              {
                component: f({
                ...
                keepOpen: !0,
                action: (o) => {
                  h.setSendErrorReportsAllowed(!h.isSendErrorReportsAllowed()), ie(o, h.isSendErrorReportsAllowed());
                }
              },
              { component: "hr" },
              {
          ...
          },
          {
            component: f({
              icon: d.vaadinLogo,
              label: "Copilot",
              hint: h.isActivationShortcut() ? X.toggleCopilot : void 0,
  ...
  handleMenuItemClick(e) {
    e.action && (e.action(e), e.keepOpen && _t());
  }
  firstUpdated() {
    ue(this.shadowRoot);
  }
...
var Tt = Object.defineProperty, Ht = Object.getOwnPropertyDescriptor, j = (e, t, i, n) => {
  for (var o = n > 1 ? void 0 : n ? Ht(t, i) : t, s = e.length - 1, a; s >= 0; s--)
    (a = e[s]) && (o = (n ? a(t, i, o) : a(o)) || o);
  return n && o && Tt(t, i, o), o;
};
const b = "resize-dir", ne = "floating-resizing-active";
let R = class extends I {
  constructor() {
    super(...arguments), this.panelTag = "", this.dockingItems = [
      ...
      this.panelInfo?.floating && (this.floatingResizingStarted || (this.removeAttribute("resizing"), this.removeAttribute(ne), this.removeAttribute("dragging"), this.style.removeProperty("--resize-cursor"), this.removeAttribute(b)));
      ...
      () => {
        requestAnimationFrame(() => {
          this.toggleAttribute(
            ...
            r.operationInProgress === ce.DragAndDrop && this.panelInfo?.floating && !this.panelInfo.showWhileDragging
          );
        });
      }
    ), this.reaction(
...
j([
  D()
], R.prototype, "panelTag", 2);
j([
  O(".drag-handle")
], R.prototype, "headerDraggableArea", 2);
j([
  O("#content")
], R.prototype, "contentArea", 2);
j([
  O('[part="container"]')
], R.prototype, "container", 2);
j([
  C()
], R.prototype, "dockingItems", 2);
R = j([
  y("copilot-section-panel-wrapper")
], R);
const re = window.Vaadin.copilot.customComponentHandler;
if (!re)
...
g.on("undoRedo", (e) => {
  const i = { files: jt(e), uiId: tt() }, n = e.detail.undo ? "copilot-plugin-undo" : "copilot-plugin-redo", o = e.detail.undo ? "undo" : "redo";
  it(o), Ut(ce.RedoUndo), pe(n, i, (s) => {
    s.data.performed || (M({
      type: _.INFORMATION,
...
function jt(e) {
  ...
  const t = re.getActiveDrillDownContext();
  if (t) {
    const i = re.getCustomComponentInfo(t);
    if (i)
      return new Array(i.customComponentFilePath);
  }
  return nt();
}
var Nt = Object.getOwnPropertyDescriptor, Bt = (e, t, i, n) => {
...
const Ft = {
   ...
   */
  run(e) {
    le || (le = !0, queueMicrotask(() => Vt())), z.push(e);
    const t = $e;
    return $e += 1, t;
  },
  /**
...
function qt(e) {
  this._$AN !== void 0 ? (K(this), this._$AM = e, Ne(this)) : this._$AM = e;
}
function Xt(e, t = !1, i = 0) {
  const n = this._$AH, o = this._$AN;
  if (o !== void 0 && o.size !== 0) if (t) if (Array.isArray(n)) for (let s = i; s < n.length; s++) J(n[s], !1), K(n[s]);
  else n != null && (J(n, !1), K(n));
  else J(this, e);
}
const Yt = (e) => {
  e.type == Me.CHILD && (e._$AP ??= Xt, e._$AQ ??= qt);
};
class Wt extends lt {
  constructor() {
  ...
  _$AT(t, i, n) {
    super._$AT(t, i, n), Ne(this), this.isConnected = t._$AU;
  }
  _$AO(t, i = !0) {
    t !== this.isConnected && (this.isConnected = t, t ? this.reconnected?.() : this.disconnected?.()), i && (J(this, t), K(this));
  }
  setValue(t) {
    if (dt(this._$Ct)) this._$Ct._$AI(t, this);
    else {
 ...
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */
const oe = Symbol("contentUpdateDebouncer");
class fe extends Gt {
  /**
   ...
   */
  removeRenderer() {
    this.element[this.rendererProperty] = null, delete this.element[oe];
  }
}
class Kt extends fe {
  get rendererProperty() {
...
const ei = he(Kt), ti = he(Zt), ii = he(Qt);
var ni = Object.defineProperty, oi = Object.getOwnPropertyDescriptor, Be = (e, t, i, n) => {
  for (var o = n > 1 ? void 0 : n ? oi(t, i) : t, s = e.length - 1, a; s >= 0; s--)
    (a = e[s]) && (o = (n ? a(t, i, o) : a(o)) || o);
  return n && o && ni(t, i, o), o;
};
let de = class extends De {
  ...
  firstUpdated(e) {
    super.firstUpdated(e), ue(this.renderRoot);
  }
  render() {
...
g.on("copilot-java-after-update", (e) => {
  ...
  M({
    type: _.INFORMATION,
    message: `Java changes were hot deployed for ${ht(t)}`,
